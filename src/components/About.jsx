...
function TimelineItem({ item, index }) {
  ...
  return (
    ...
    >
      ...
      />
      <div className="glass p-5 rounded-xl hover:border-[var(--border)] transition-all duration-300">
        <div className="flex flex-wrap items-center gap-2 mb-1">
          <span className="text-[10px] font-mono text-[var(--text-secondary)]">{item.period}</span>
          {item.current && (
        ...
        <div className="text-[var(--text-primary)] font-bold text-sm">{item.role}</div>
          ...
          <div>
            ...
            >
              {highlights.map(({ icon: Icon, label, value, sub }) => (
                <div key={label} className="glass p-4 rounded-xl hover:border-[var(--border)] transition-all duration-300">
                  ...
                  <div className="text-[var(--text-primary)] text-xs font-bold leading-tight">{value}</div>
                  <div className="text-[var(--text-secondary)] text-[10px]">{sub}</div>
                </div>
              ))}
            </motion.div>
          </div>
